...
const NEZHA_KEY = process.env.NEZHA_KEY || '6ItGHErK9kbI0RBr1e';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
...
const DOMAIN = process.env.DOMAIN || 'btpp03.btpp.hf.space';                   // 域名或ip,留空将自动获取服务器ip
